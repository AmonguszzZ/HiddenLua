...
-- // ui
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/AmonguszzZ/HiddenLua/refs/heads/main/UI.lua"))()
...
local RecorderInit = loadstring(game:HttpGet("https://raw.githubusercontent.com/AmonguszzZ/HiddenLua/refs/heads/main/Recorder.lua"))()
RecorderInit({
    Window = Window,
        ...
        while Globals.AutoGatling do
            if GameState == "GAME" then
                if not GatlingExecuted then
                    ...
                    task.spawn(function()
                        pcall(function()
                            loadstring(game:HttpGet("https://raw.githubusercontent.com/AmonguszzZ/HiddenLua/refs/heads/main/Gatling.lua"))()
                        end)
                    end)
                end
            else
